...
class UserControllerTests {
    ...
    void createUserTest() throws Exception {
        ...
        when(userService.create(this.mockUser.getUsername(), VALID_PASSWORD)).thenReturn(this.mockUser);
    ...
    void createUserWithInvalidPasswordTest() throws Exception {
        ...
        when(userService.create(this.mockUser.getUsername(), this.mockUser.getPassword())).thenReturn(this.mockUser);
    ...
    void createUserWithInvalidNameTest() throws Exception {
        ...
        when(userService.create("   ", VALID_PASSWORD)).thenReturn(this.mockUser);
